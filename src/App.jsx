          ...
          element={
            ...
            >
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
                  ...
                  >
                    ...
                    >
                      ...
                      giữa tồn tại xã hội và ý thức xã hội qua biểu đồ tương tác
                      và trò chơi mô phỏng cuộc sống.
                    </motion.p>
              ...
              <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 py-16">
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-slate-600 text-lg">
                      Ba khái niệm chính giúp lý giải hành vi xã hội
                    </p>
                  </motion.div>
                ...
                {/* Add Home component content here */}
                <motion.div
                  initial={{ opacity: 0, y: 40 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center">
            ...
            >
              "Theo quan điểm triết học Mác–Lênin: tồn tại xã hội quyết định ý
              thức xã hội".
            </motion.blockquote>
          </div>
        </motion.footer>
