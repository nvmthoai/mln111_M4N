          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-600 mb-4 max-w-4xl mx-auto leading-relaxed">
              ...
              <span className="font-semibold text-blue-700">
                {" "}
                Chủ nghĩa Duy vật Lịch sử (MLN)
              </span>
            </p>
            <p className="text-lg text-slate-500 max-w-3xl mx-auto">
              Hiểu rõ tại sao thế hệ trẻ ngày nay ngại kết hôn và sinh con thông
              qua mối quan hệ biện chứng giữa
              <Link
                to="/quan-he"
                className="text-blue-600 hover:text-blue-800 "
              >
                <strong> tồn tại xã hội</strong> và{" "}
                <strong>ý thức xã hội</strong>
              </Link>
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Ý thức xã hội là mặt tinh thần của đời sống xã hội, phản ánh
                điều kiện tồn tại vật chất và có tác động ngược lại.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Tồn tại xã hội quyết định ý thức xã hội, nhưng ý thức xã hội
                cũng có tính độc lập tương đối và tác động ngược lại.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Giải thích xu hướng trì hoãn hôn nhân của giới trẻ qua áp lực
                kinh tế và sự thay đổi quan niệm.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Khám phá 10 câu chuyện thực tế minh họa cho lý thuyết MLN về vấn
              đề hôn nhân - gia đình hiện đại
            </p>
          </motion.div>
        </div>
      </motion.section>
            ...
            {[
              {
                ...
                content:
                  "Chính trị, Pháp quyền, Đạo đức, Tôn giáo, Thẩm mỹ, Khoa học, Triết học",
              ...
              },
              {
                ...
                content:
                  "Tồn tại quyết định ý thức, nhưng ý thức cũng tác động ngược lại",
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${item.color} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity blur-xl`}
                />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Tìm hiểu về các chương khác của lý thuyết MLN và ứng dụng vào đời
              sống
            </p>
            <motion.button
